...
const PROMPT = `
จากข้อมูลที่ได้รับ ให้เขียนบทความสำหรับให้ผู้อื่นลงทำตามได้อย่างน่าสนใจ ที่เหมือนกำลังเป็น นักทดลอง software ใหม่ๆ และถ้ามีรูปเอามาแสดงไว้ในช่วงแรกๆ สักรูปด้วยโดยใช้ url full path, ไม่เขียนอ้างอิง และ title ใน content อีกรอบ, ไม่ต้องทักทาย,responses in JSON format only.
