      ...
      <div class="row">
        <div class="col-lg-9 col-md-11 d-none d-md-block">
          <div class="profile-img d-flex justify-content-end">
            <img src="~assets/studio-session-755.webp" loading="lazy" width="230" height="280" alt="">
          </div>
        </div>
        <div class="col-lg-27 col-md-25 col-sm-36 name-wrapper">
          ...
          <div class="d-print-none mt-1">
            ...
            <img alt="counter" height="20" loading="lazy" src="https://komarev.com/ghpvc/?username=dvgamerr&color=97ca00&style=flat-square&label=views&labelColor=1c1917" />
          </div>
